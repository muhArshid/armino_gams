...
class AppColorCode {
  ...
  static const Color orangeCardColor = Color(0xFFFB762B);
  ...
  static const Color cardBackgroundColor = Color(0xFF2B2D47);

  static const Color brandColor = Color(0xFF7560E3);
  //text
  static const Color text1 = Color.fromRGBO(34, 33, 91, 1);
  static const Color headerColor = Color(0xFF7560E3);
  static const Color labelColor = Color(0xFFF3FEFF);
  static const Color mainHeaderColor = Color(0xFF696C75);
  static const Color subHeaderColor = Color(0xFF1F2137);
  static const Color cardColor = Color(0xFF2B2D47);
  //butten
...
//gradient
  static const Color gradient1 = Color(0xFF8F97A0);
  static const Color gradient2 = Color(0xFFFFEEDF);
